...
<body>
		...
		<div class="select-city">
			...
			<select class="list_of_cities">
				<optgroup label="Popular Cities">
					<option selected style="display:none;color:#eee;">Select</option>
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> 123 Brenys, Venezuela.</li>
							<li class="mb-3">
								<i class="fas fa-mobile"></i> 0414 222 3333 </li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> +241 11 4444 </li>
							<li class="mb-3">
								<i class="fas fa-envelope-open"></i>
								<a href="mailto:brenlysquintero@mail.com">  bqElectronics@gmail.com</a>
							</li>
							<li>
								<i class="fas fa-envelope-open"></i>
								<a href="mailto:brenlysquintero@mail.com"> bqElectronics@gmail.com</a>
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2020 BQ electronics. All rights reserved | Design by Doumer Alexander
				</p>
		</div>
	</div>
	<!-- //copyright -->
...
</html><?php /**PATH C:\xampp\htdocs\my-app\resources\views/layout.blade.php ENDPATH**/ ?>